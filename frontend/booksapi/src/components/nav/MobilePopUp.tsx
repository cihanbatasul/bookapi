...
import { logoutUser as logOutUserReducer } from "../../store/userReducer";
...
const logoutUser = () => {
  ...
  return (
    <motion.div
      ...
      className="z-50 absolute w-full h-screen  bg-background rounded-md flex flex-col gap-3 text-black dark:text-white text-xl justify-center"
    >
