...
interface Props extends React.HTMLAttributes<HTMLDivElement> {
    libraries?: Shelves
    sideBarAction: Dispatch<React.SetStateAction<number>>
}
            ...
            <div className="space-y-4 py-4">
                <div className="px-3 py-2">
                    ...
                    <div className="space-y-1">
                        ...
                        <Button variant="ghost" className="w-full justify-start" onClick={() => sideBarAction(0)}>
                            <svg
                ...
                <div className="px-3 py-2">
                    ...
                    <div className="space-y-1">
                        <Button variant="ghost" className="w-full justify-start" onClick={() => sideBarAction(1)}>
                            <Library className="mr-2 h-4 w-4" />
                            Libraries
                        </Button>
                        <Button variant="ghost" className="w-full justify-start" onClick={() => sideBarAction(2)}>
                            <Book className="mr-2 w-4 h-4" />
                            All Books
                        </Button>
                        <Button variant="ghost" className="w-full justify-start" onClick={() => sideBarAction(3)}>
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24"
                                fill="none"
                        ...
                        <Button variant="ghost" className="w-full justify-start" onClick={() => sideBarAction(4)}>
