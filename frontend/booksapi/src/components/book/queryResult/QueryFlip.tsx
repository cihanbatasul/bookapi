...
const QueryFlip: FC<props> = ({ ...props }) => {
  ...
  return (
    <motion.div
      className="flip-card perspective-1000  flex flex-col min-h-[520px] w-[370px] p-3 lg:p-12 shadow-lg overflow-y-scroll border border-gray-300 dark:border-none ">
      <motion.div className="flip-card-inner w-full h-full transition-transform transform transform-style-preserve-3d duration-500 "
        initial={false}
        ...
        {isFlipped ?
          <motion.div className={`flip-card-back absolute backface-hidden bg-cover bg-[url('${props.details.imageLinks.large}')] flex  flex-col justify-center items-center relative`}
          >
            <motion.div
          ...
          <motion.div className="flip-card-front backface-hidden w-full h-full flex flex-col gap-3">
            <motion.div>
