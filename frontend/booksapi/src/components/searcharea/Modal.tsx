...
const Modal: FC<props> = ({ ...props }) => {
    ...
    return (
        <motion.div
            ...
            className="  bg-white z-50 dark:bg-gray-800 text-black dark:text-inherit flex flex-col gap-4 p-3 rounded-md shadow-lg border border-gray-300 dark:border-none">
