...
const SearchBar2: FC<props> = ({...props}) => {
  ...
  return (
    ...
    className="p-3 md:p-5 lg:p-12 lg:w-[50%] lg:mx-auto ">
    <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white shadow-lg">Search</label>
