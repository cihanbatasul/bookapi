...
const SearchArea = () => {
  ...
  const removeFilter = (filter: string) => {
    ...
    try{
      ...
      const imagePromises = data.items.map(async (item: Query) => {
     ...
     // useEffect(() => {
     //   // Check if the user has interacted with the search feature
     //   if (searchResults !== undefined && (orderBy || maxBooks || epubs)) {
     //     handleSearchSubmit();
     //   }
     // }, [orderBy, maxBooks, epubs]);
