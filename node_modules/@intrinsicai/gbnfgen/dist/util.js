import { charPattern, group, literal, reference, sequence, } from "./grammar.js";
...
const NUMBER_ELEM = {
    identifier: "number",
    alternatives: [
        sequence(charPattern(/[0-9]+/g), charPattern(/"."?/g), charPattern(/[0-9]*/g)),
    ],
};
export const STRING_REF = reference(STRING_ELEM.identifier);
export const NUMBER_REF = reference(NUMBER_ELEM.identifier);
export const WS_REF = reference(WS_ELEM.identifier);
const NUMBERLIST_ELEM = {
    identifier: "numberlist",
    alternatives: [
        // Empty list
        sequence(literal(`[`), WS_REF, literal(`]`)),
        // Non-empty list
        sequence(literal(`[`), WS_REF, STRING_REF, group(sequence(literal(`,`), WS_REF, NUMBER_REF), "star"), WS_REF, literal(`]`)),
    ],
};
const STRINGLIST_ELEM = {
    identifier: "stringlist",
    alternatives: [
        // Empty list
        sequence(literal(`[`), WS_REF, literal(`]`)),
        // Non-empty list
        sequence(literal(`[`), WS_REF, STRING_REF, group(sequence(literal(`,`), WS_REF, STRING_REF), "star"), WS_REF, literal(`]`)),
    ],
};
/**
